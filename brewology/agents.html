					...
					<div class="row row-fit-10">
						...
						<div class="col-md-12">
							<div class="agent fully-styled">
								<div class="image">
									<a href="agent.html">
										<img src="img/agent-3.jpg" alt="agent photo" />
									</a>
								</div>

								<h3><a href="agent.html">Carl Doe</a></h3>
								<p class="position">agent</p>
						...
						<div class="col-md-12">
							<div class="agent fully-styled">
								<div class="image">
									<a href="agent.html">
										<img src="img/agent-4.jpg" alt="agent photo" />
									</a>
								</div>

								<h3><a href="agent.html">Frank Doe</a></h3>
								<p class="position">agent</p>
						...
						<div class="col-md-12">
							<div class="agent fully-styled">
								<div class="image">
									<a href="agent.html">
										<img src="img/agent-5.jpg" alt="agent photo" />
									</a>
								</div>

								<h3><a href="agent.html">Caleb Doe</a></h3>
								<p class="position">agent</p>
						...
						<div class="col-md-12">
							<div class="agent fully-styled">
								<div class="image">
									<a href="agent.html">
										<img src="img/agent-6.jpg" alt="agent photo" />
									</a>
								</div>
						...
						<div class="col-md-12">
							<div class="agent fully-styled">
								<div class="image">
									<a href="agent.html">
										<img src="img/agent-7.jpg" alt="agent photo" />
									</a>
								</div>
						...
						<div class="col-md-12">
							<div class="agent fully-styled">
								<div class="image">
									<a href="agent.html">
										<img src="img/agent-8.jpg" alt="agent photo" />
									</a>
								</div>

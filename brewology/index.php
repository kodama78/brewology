		...
		<div class="content-wrapper">
			...
			<div class="login-form-popup">
				<div class="login-form" id="login-popup">
					...
					<form id="login-form">
						<input class="js-input" type="text" placeholder="Email" id="login"/>
						<input class="js-input" type="password" placeholder="Password" id="password" />

						<button class="submit-button" id="loginBtn">Login</button>
